...
if __name__ == '__main__':
    ...
    parser.add_argument('--annotations', type=int, default=10, help="Number of annotations per video (in SM-VideoXum = 10)")
    ...
    parser.add_argument('--dataset', type=str, default='SM_VideoXum', help="The name of the dataset")
