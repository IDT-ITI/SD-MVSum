...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp_num', type=str, default='exp', help='Creates the dir to save results')
    ...
    parser.add_argument('--ckpt_path', type = str, default = 'NO./Summaries/exp_/best_f1score_model/best_f1.pkl', help = 'checkpoint path for inference or weight initialization')
