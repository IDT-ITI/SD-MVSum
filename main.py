...
from model.solver import SolverFactory
import argparse

if __name__ == '__main__':

    parser = argparse.ArgumentParser()
    parser.add_argument('--exp_num', type=str, default='exptest', help='Creates the dir to save results')
    ...
    parser.add_argument('--ckpt_path', type = str, default = 'No./Summaries/exp10/best_f1score_model/best_f1.pkl', help = 'checkpoint path for inference or weight initialization')
    ...
    parser.add_argument('--annotations', type=int, default=10, help="Number of annotations per video (S-VideoXum = 10")
    parser.add_argument('--visual_weights', type=str2bool, default=True, help="")
    parser.add_argument('--transcript_weights', type=str2bool, default=True, help="")

    parser.add_argument('--dataset', type=str, default='S_VideoXum', help="The name of the dataset: ['S_VideoXum' | 'S_MrhiSum']")
    ...
    solver = SolverFactory(config, config.dataset, train_loader, val_loader, test_loader)
    solver.build()
